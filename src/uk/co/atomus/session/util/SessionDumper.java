...
public class SessionDumper {
	public static void main(String[] args) throws Exception {
		...
		List<TomcatSessionStorageEntity> entities = sessionDao.queryEntitiesByKeys(partitionKey, rowKey);
		...
		for (TomcatSessionStorageEntity tableStorageEntity : entities) {
	...
	private static void dumpTableStorageEntity(TomcatSessionStorageEntity tableStorageEntity, SessionMapper sessionMapper,
